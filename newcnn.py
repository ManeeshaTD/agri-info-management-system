...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\User\Music\Resso Music\crop_predictionweb\crop_predictionweb\src\static\dataset\rice_leaf_diseases')
    i=-1
    ii=0
    for pa in my_list:
        ...
        print(pa,"==================")
        i=i+1
        for root, dirs, files in os.walk(r'C:\Users\User\Music\Resso Music\crop_predictionweb\crop_predictionweb\src\static\dataset\rice_leaf_diseases\\' + pa):

         for f in files:


             file_path = os.path.join(r'C:\Users\User\Music\Resso Music\crop_predictionweb\crop_predictionweb\src\static\dataset\rice_leaf_diseases\\'+pa, f)
...
# # load dataset
# x_dataset, y_dataset = read_dataset(r"C:\Users\User\Music\Resso Music\crop_predictionweb\crop_predictionweb\src\static\dataset\rice_leaf_diseases")
...
# print(predictld(r"C:\Users\User\Music\Resso Music\crop_predictionweb\crop_predictionweb\src\static\dataset\rice_leaf_diseases\Leaf smut\DSC_0508.jpg"))